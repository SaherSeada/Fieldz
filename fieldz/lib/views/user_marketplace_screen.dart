...
class UserMarketplaceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => controller.isLoaded.value ? RefreshIndicator(onRefresh: () async {await controller.getProducts();}, child: GridView.builder(
                  ...
                  child: Card(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        // Product title
                        SizedBox(
                          height: 65, child: Align(alignment: Alignment.centerLeft, child: 
                        Padding(
